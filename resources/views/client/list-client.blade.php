                    ...
                    <table class="container__tabela">
                        <thead class="tabela__topo">
                            <tr class="topo__items">
                                ...
                                <th class="item">CEP</th>
                                <th class="item">Endereco</th>
                                <th class="item">Bairro</th>
                        ...
                        <tbody class="tabela__corpo">
                            @foreach($clients as $client)
                                <tr class="tabela__items">
                                    ...
                                    <td>
                                        <a href="/client/edit/{{ $client->idcliente }}">editar</a>
                                        <a href="/client/delete/{{ $client->idcliente }}">excluir</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
