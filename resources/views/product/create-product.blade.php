        ...
        <div class="conteudo">
            ...
            <main>
                <div class="container__main">
                    ...
                    <section>
                        <form class="formulario" method="post" action="{{ route('product.store')}}"> 
                            @csrf
                            @method( session('post'))
                            ...
                            <div class="container-form">
                                <div class="field item__form_product sm-form ">
                                    <label for="codigoProduto" class="titulo-form">Código Produto:</label>
                                    <input type="number" id="codigoProduto" name="codigoProduto" placeholder="Código Produto*">
                                </div>
                                ...
                                <div class="field item__form_product elg-form">
                                    <label for="descricaoProduto" class="titulo-form">Descrição do Produto:</label>
                                    <input type="text" id="descricaoProduto" name="descricaoProduto" placeholder="Descrição*">
                                </div>
                                <div class="field item__form_product sm-form">
                                    <label for="precoProduto" class="titulo-form">Preço do Produto:</label>
                                    <input type="number" step="0.01" id="precoProduto" name="precoProduto" placeholder="Preço*">
                                </div>
                                <div class="field item__form_product sm-form">
                                ...
                                <div class="field select som-form">
                                    <fieldset id="ativo">
                                        ...
                                        <input type="radio" value="0" name="ativo">Não
                                    </fieldset>
                                </div>                               
                            </div>
                                <div >
